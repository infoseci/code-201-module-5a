...
Today in lab you will create your own repo using the [code-201-module-5a Template Repo](https://github.com/infoseci/code-201-module-5a){:target="_blank"}, and then create solutions to some code problems such that your solutions pass the included tests.
...
* Although this is an individual module assignment, do feel free to collaborate and work in pairs or groups.

## Resources

This module will have starter code provided. Work with your instructor directly to gain access to this code.
